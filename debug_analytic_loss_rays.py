...
from solar_ray_integration.training.ray_samples_dataset import SolarRayPixelDataModule
from solar_ray_integration.training.dataset import SolarPerspectiveDataModule
from solar_ray_integration.ray_integration.integrate_field import calculate_rays, collapse_output
...
def compute_analytic_loss(
    ...
    for b_idx, batch in enumerate(loader):
        ...
        #     ).squeeze(1)
        output = evaluate(obs=obs.to(device), ray=rays.to(device), requires_grad=False)
